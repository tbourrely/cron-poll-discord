...
use cron_poll_discord::api::handlers::{create_poll, create_poll_in_poll_group, delete_poll, get_answers_from_poll, get_answers_from_poll_group, get_poll, get_poll_groups, get_poll_instance, get_poll_instances, get_polls, update_poll};
...
async fn main() {
    ...
    let app = Router::new()
        ...
        .route(
            ...
            get(get_answers_from_poll),
        )
        .route("/poll-groups", get(get_poll_groups).post(create_poll_in_poll_group))
        .route("/poll-groups/{id}/instances/answers", get(get_answers_from_poll_group))
        .with_state(pool);
